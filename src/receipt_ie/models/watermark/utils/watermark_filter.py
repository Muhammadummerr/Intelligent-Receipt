...
WM_MODEL_ID = "muhammadummerrr/vit-water-mark-detector-v1-extended"
...
def check_watermark(image_path: str, ocr_text: str = "") -> (bool, str):
    """
    Combined filter:
    1️. Check textual watermarks in OCR text.
    2️. Check visual watermark probability via ViT classifier.
    """
    # textual pass
    if ocr_text:
