...
boxes.py
----------
OCR bounding-box parsing utilities for receipt layouts.
Handles:
- Parsing .txt files containing 8-point quadrilateral coordinates
- Sorting by reading order (top-to-bottom, left-to-right)
- Scaling coordinates to LayoutLMv3 [0–1000] range
"""
